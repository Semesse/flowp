...
- [Progress](api/flowp.progress) A promise but with progress report
...
- [Mutex](api/flowp.mutex) Specialized Semaphore(1)
- [Channel](api/flowp.channel) Powerful asynchronos message queue
...
- [lateinit](api/flowp.lateinit) deletgate property access and function calls of a promise, powered by [Proxy](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Proxy)
